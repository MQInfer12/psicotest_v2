...
const Icon = ({ type }: Props) => {
  const icons: Record<ICON, JSX.Element> = {
    ...
    [ICON.CHEVRON_DOWN]: <IconChevron type="down" />,
    [ICON.USER]: <IconUser />,
    ...
    [ICON.PATIENT_SINGLE]: <IconPatient single />,
    [ICON.HOME]: <IconHome />,
    [ICON.BLOG]: <IconBlog />,
    ...
    [ICON.TIMELINE]: <IconTimelane type="up" />,
    [ICON.TIMELINE_DOWN]: <IconTimelane type="down" />,
