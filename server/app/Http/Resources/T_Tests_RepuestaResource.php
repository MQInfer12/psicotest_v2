...
class T_Tests_RepuestaResource extends JsonResource
{
    public function toArray($request)
    {
        ...
        return [
            ...
            'test' => $this->test_version->test,
            'genero_user' => $this->user->genero,
            'telefono_user' => $this->user->telefono,
            'nombre_tutor_user' => $this->user->nombre_tutor,
            'telefono_tutor_user' => $this->user->telefono_tutor,
            'estado' => $this->estado,
